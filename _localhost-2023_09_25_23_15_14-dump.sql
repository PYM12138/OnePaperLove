...
INSERT INTO `archives` (`id`, `archiveName`) VALUES (1,'2018年07月'),(2,'2018年08月');
...
--
-- Dumping data for table `article_likes_record`
--

LOCK TABLES `article_likes_record` WRITE;
/*!40000 ALTER TABLE `article_likes_record` DISABLE KEYS */;
INSERT INTO `article_likes_record` (`id`, `articleId`, `likerId`, `likeDate`, `isRead`) VALUES (1,1532884460,1,'2018-07-31 20:00',0),(2,1533196734,1,'2018-08-02 21:24',0);
...
INSERT INTO `categories` (`id`, `categoryName`) VALUES (1,'我的故事'),(2,'SpringBoot');
...
--
-- Dumping data for table `comment_likes_record`
--

LOCK TABLES `comment_likes_record` WRITE;
/*!40000 ALTER TABLE `comment_likes_record` DISABLE KEYS */;
INSERT INTO `comment_likes_record` (`id`, `articleId`, `pId`, `likerId`, `likeDate`) VALUES (1,1533196734,2,1,'2023-07-16 23:34');
...
INSERT INTO `comment_record` (`id`, `pId`, `articleId`, `answererId`, `respondentId`, `commentDate`, `likes`, `commentContent`, `isRead`) VALUES (2,0,1533196734,1,1,'2018-08-03 00:13',2,'测试评论功能，嘻嘻嘻',0),(3,2,1533196734,1,1,'2018-08-03 00:15',0,'一切正常，哈哈哈',0),(4,2,1533196734,1,1,'2023-07-16 23:33',0,'123',0);
...
--
-- Dumping data for table `leave_message_likes_record`
--

LOCK TABLES `leave_message_likes_record` WRITE;
/*!40000 ALTER TABLE `leave_message_likes_record` DISABLE KEYS */;
INSERT INTO `leave_message_likes_record` (`id`, `pageName`, `pId`, `likerId`, `likeDate`) VALUES (1,'tags',16,1,'2023-07-16 23:53');
...
--
-- Dumping data for table `leave_message_record`
--

LOCK TABLES `leave_message_record` WRITE;
/*!40000 ALTER TABLE `leave_message_record` DISABLE KEYS */;
INSERT INTO `leave_message_record` (`id`, `pageName`, `pId`, `answererId`, `respondentId`, `leaveMessageDate`, `likes`, `leaveMessageContent`, `isRead`) VALUES (14,'categories',0,1,1,'2018-09-19 13:53',0,'分类留言测试',0),(15,'archives',0,1,1,'2018-09-19 13:53',0,'归档留言',0),(16,'tags',0,1,1,'2018-09-19 13:53',1,'标签留言',0),(17,'update',0,1,1,'2018-09-19 13:53',0,'更新留言',0),(18,'friendlylink',0,1,1,'2018-09-19 13:54',0,'需要添加友链的朋友可在www.zhyocean.cn/friendlylink下方留言（网站名称+网址），随后验证后会在本人博客中添加友链链接',0);
...
--
-- Dumping data for table `privateword`
--

LOCK TABLES `privateword` WRITE;
/*!40000 ALTER TABLE `privateword` DISABLE KEYS */;
INSERT INTO `privateword` (`id`, `privateWord`, `publisherId`, `replierId`, `replyContent`, `publisherDate`) VALUES (8,'悄悄话测试','1','1','?\n','2018-09-19 14:13:32');
...
INSERT INTO `reward` (`id`, `fundRaiser`, `fundRaisingSources`, `fundraisingPlace`, `rewardMoney`, `remarks`, `rewardDate`, `rewardUrl`) VALUES (1,'海**依','公众号赞赏','《搜狐焦点·拯救先心儿》',20,'无','2019-07-04 00:00:00','https://zhy-myblog.oss-cn-shenzhen.aliyuncs.com/public/rewardRecord/2019-07-15/1563121018.jpeg');
...
INSERT INTO `tags` (`id`, tag_name, `tagSize`) VALUES (1,'随笔感悟',15),(4,'SpringBoot',17),(5,'个人博客',18),(18,'原创',20);
...
INSERT INTO `user` (`id`, `phone`, `username`, `password`, `gender`, `trueName`, `birthday`, `email`, `personalBrief`, `avatarImgUrl`, `recentlyLanded`) VALUES (1,'19940790216','张海洋','a3caed36f0fe5a01e5f144db8927235e','male','张海洋','1997-07-05','1125694337@qq.com','','https://zhy-myblog.oss-cn-shenzhen.aliyuncs.com/public/user/avatar/张海洋/1575283189.png','2023-07-16 23:32:42');
...
INSERT INTO `visitor` (`id`, `visitorNum`, `pageName`) VALUES (1,3228,'totalVisitor'),(2,1032,'visitorVolume'),(3,42,'article/1532884460'),(5,57,'article/1533196734');
...
-- Dump completed on 2023-09-25 23:15:15
