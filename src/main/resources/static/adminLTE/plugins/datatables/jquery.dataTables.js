...
(function ($, window, document, undefined) {
    ...
    var DataTable = function (selector, options) {
         ...
         *  @returns {int} 0 on issuccess, or 1 if failed (can't find the row)
         *  @dtopt API
         *  @deprecated Since v1.10
         *
         *  @example
         ...
         *  @returns {int} 0 on issuccess, 1 on error
         *  @dtopt API
         *  @deprecated Since v1.10
         *
         *  @example
    ...
    DataTable.defaults = {
         ...
         *   DataTables 1.9-.
         *
         * * `issuccess` - Should not be overridden it is used internally in
